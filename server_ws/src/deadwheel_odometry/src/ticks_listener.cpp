...
class TicksListener : public rclcpp::Node
{
  private : 
    ...
    const double DEADWHEEL_DISTANCE = 0.14994; //distance entre les deux deadwheel principaux, anciennement 0.1446
    const double OFFSET = -0.05903; //distance entre le side deadwheel et le centre de rotation du robot
