...
static const _DeadwheelTicks_type_support_symbol_names_t _DeadwheelTicks_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deadwheel_msgs, msg, DeadwheelTicks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deadwheel_msgs, msg, DeadwheelTicks)),
  }
};
...
{
  return &::deadwheel_msgs::msg::rosidl_typesupport_cpp::DeadwheelTicks_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deadwheel_msgs, msg, DeadwheelTicks)() {
  return get_message_type_support_handle<deadwheel_msgs::msg::DeadwheelTicks>();
}
