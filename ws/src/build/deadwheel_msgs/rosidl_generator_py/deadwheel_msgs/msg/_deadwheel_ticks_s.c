...
bool deadwheel_msgs__msg__deadwheel_ticks__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // t0
    ...
    ros_message->t0 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // t1
    ...
    assert(PyLong_Check(field));
    ros_message->t1 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // t2
    ...
    assert(PyLong_Check(field));
    ros_message->t2 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * deadwheel_msgs__msg__deadwheel_ticks__convert_to_py(void * raw_ros_message)
{
  ...
  {  // t0
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->t0);
    {
  ...
  {  // t1
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->t1);
    {
  ...
  {  // t2
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->t2);
    {
